    ...
    return (
         <div className="">
          <div className="w-full h-[100vh] flex justify-center items-center">
            <div className="w-[30rem] h-[45rem] bg-blue-400 top-[20%] rounded-[1rem] p-[1.4rem_2rem] ">
              <h1 className="text-[3rem] font-semibold text-white mt-4">
                Payment details
              </h1>
              <div className="signin flex justify-center items-center flex-col gap-[1.2rem] mt-10">
                <input
                  type="text"
